...
modalapp
    .controller('modal3controller', function ($scope, $uibModal, $log) {
    //然后就是主控制器,没什么,注意$uibModal这个东西,也是要在控制器中引入的
      ...
      $scope.open = function (size) {
        ...
        var modalInstance = $uibModal.open({
          ...
          templateUrl: 'modal3.html',//模态框的页面内容,这里的url是可以自己定义的,也就意味着什么都可以写
          controller: 'Modal3InstanceCtrl',//这是模态框的控制器,是用来控制模态框的
          size: size,//模态框的大小尺寸
...
modalapp
    .controller('Modal3InstanceCtrl', function ($scope, $uibModalInstance, items) {
